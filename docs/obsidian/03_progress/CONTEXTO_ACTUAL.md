...
- **Virtual Sub-Database Environment:** al crear escuela se provisiona tenant con admin inicial desde secretos de entorno, roles base, ciclo actual, grados, materias y grupo inicial. School Admin ahora tiene `/school-admin/database` para explorar y gestionar solo datos de su tenant, con campos/tablas virtuales seguras, export Excel e import preview.
